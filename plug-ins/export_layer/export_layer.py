...
class ExportLayer(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_menu_label("Export Layer")
        procedure.set_attribution("Raghav", "Raghav, Tileset Project", "2025")
        procedure.add_menu_path("<Image>/Tileset/Export/")
        procedure.set_documentation("Export Layer", None)

        return procedure

Gimp.main(ExportLayer.__gtype__, sys.argv)
