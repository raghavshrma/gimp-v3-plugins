...
plug_in_binary = "quick-cycle-tool"
...
class QuickCycleTool(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_menu_label("Quick Cycle Tool")
        procedure.set_attribution("Raghav", "Raghav, Tileset Project", "2025")
        procedure.add_menu_path("<Image>/Tileset/")
        procedure.set_documentation("Quick Cycle Tool", None)

        procedure.add_int_argument("index", "Index", None, 0, 100, 0, ParamFlags.READWRITE)

        return procedure

Gimp.main(QuickCycleTool.__gtype__, sys.argv)
