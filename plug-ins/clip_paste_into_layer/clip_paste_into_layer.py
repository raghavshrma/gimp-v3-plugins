...
plug_in_binary = "clip-paste-into-layer"
...
class PasteIntoLayer(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_menu_label("Paste Into Layer")
        procedure.set_attribution("Raghav", "Raghav, Tileset Project", "2025")
        procedure.add_menu_path("<Image>/Tileset/Clipboard/")
        procedure.set_documentation("Paste Into Layer", None)

        return procedure


Gimp.main(PasteIntoLayer.__gtype__, sys.argv)
