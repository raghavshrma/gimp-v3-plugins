...
plug_in_binary = "clip-replace-below"
...
class ClipReplaceBelow(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_menu_label("Replace Below")
        procedure.set_attribution("Raghav", "Raghav, Tileset Project", "2025")
        procedure.add_menu_path("<Image>/Tileset/Clipboard/")
        procedure.set_documentation("Replace Below", None)

        return procedure

Gimp.main(ClipReplaceBelow.__gtype__, sys.argv)
