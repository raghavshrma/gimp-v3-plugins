...
class SliceByGrid(Gimp.PlugIn):
    ...
    def do_create_procedure(self, name):
        ...
        procedure.set_menu_label("Slice by Grid")
        procedure.set_attribution("Raghav", "Raghav, Tileset Project", "2025")
        procedure.add_menu_path("<Image>/Tileset/Transform/")
        procedure.set_documentation("Slice by Grid", None)

        return procedure

Gimp.main(SliceByGrid.__gtype__, sys.argv)
