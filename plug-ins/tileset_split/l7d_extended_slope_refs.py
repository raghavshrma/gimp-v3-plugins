...
def _build_slopes_1(bld: Builder, idx: int, x: int, y: int):
    ...
    t_raw.add(2, 2, [bld.edge_left(), bld.inner_corner_tl_extra()])
    t_raw.add(3, 1, bld.edge_top_full())
    t_raw.add(5, 1, bld.edge_top_full())
    t_raw.add(6, 2, [bld.edge_right(), bld.inner_corner_tr_extra()])
    ...
    t_ref.add(3, 3, bld.deep_left())
    t_ref.add(4, 3, bld.center_dark())
    t_ref.add(5, 3, bld.deep_right())
